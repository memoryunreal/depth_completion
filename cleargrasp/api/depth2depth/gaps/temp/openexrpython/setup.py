...
setup(name='OpenEXR',
  ...
  ext_modules=[ 
    Extension('OpenEXR',
              ['OpenEXR.cpp'],
              include_dirs=['/usr/include/OpenEXR', '/usr/local/include/OpenEXR', '/opt/local/include/OpenEXR', '/opt/conda/envs/enhanceD/include/OpenEXR'],
              library_dirs=['/usr/local/lib', '/opt/local/lib', '/opt/conda/envs/enhanceD/lib'],
